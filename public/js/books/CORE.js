...
*
*		@method find	->	finds an element and changes its innerHTML
*			@param	{Node} Parent	
*			@param	{Node} queryString
*			@param	{String}	data	//the data you want to insert
*			@return {Node} //returns the changed element
*/
...
CORE.helper.element =  (function(CORE){
		return {
			...
			find:function(Parent,queryString,data){
				var element	=	Parent.querySelector(queryString);

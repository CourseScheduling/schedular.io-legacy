...
a){for(var e=0,g=0,d=b.length;d--;)var k=c.socket.seatMap[b[d].crn],f=k.m-k.e,e=e+(1E5*(0<f)-100*k.w+f*(0<f));for(d=a.length;d--;)k=c.socket.seatMap[a[d].crn],f=k.m-k.e,g+=1E5*(0<f)-100*k.w+f*(0<f);return g-e},blockAmount:function(c,a){return a.times.length-c.times.length}}}(CORE);
